...
const Banner = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-10 items-center pb-5">
      <section className="md:col-span-2 w-full" data-aos="fade-up">
        <Swiper
          modules={[Autoplay]}
          spaceBetween={30}
          slidesPerView={1}
      ...
      {/* Added AOS fade-up animation here */}
      <div className="card bg-base-300 w-full" data-aos="fade-up">
        <div className="card-body">
          <h2 className="card-title">
            "Adventure Awaits. Discover Your Next Journey Today."
          </h2>
          <p>
            Find the perfect tour package and explore the world your way — simple,
