  ...
  return (
    <section className="py-12 ">
      <div className="max-w-6xl mx-auto text-center px-4">
        ...
        <p className="mb-10 text-gray-600">We make your travel simple, secure, and unforgettable.</p>
        <div className="grid gap-6 md:grid-cols-3">
          <div className="p-6 bg-base-100 rounded-xl shadow hover:shadow-md transition">
